...
function HeroSection() {
    return (
        // <div className="ptb-70 hero-equal-height relative min-h-screen flex items-center text-white overflow-hidden">
        ...
        //                 </div>
        //             </div>
        //             <div className="w-full lg:w-1/2 pt-12 flex justify-center">
        //                 <div className="overflow-hidden w-full h-full md:w-80 md:h-80 lg:w-96 lg:h-96">
        //                     <img
        //                         src="/hero-section/Untitled design (7) (1) (1) (1).png"
        //                         alt="img-online-shop"
